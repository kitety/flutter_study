...
class DiamondShopLayoutTestPage extends StatefulWidget {
  const DiamondShopLayoutTestPage({Key? key}) : super(key: key);

  @override
  State<DiamondShopLayoutTestPage> createState() => _DiamondShopLayoutTestPageState();
}

class _DiamondShopLayoutTestPageState extends State<DiamondShopLayoutTestPage> {
